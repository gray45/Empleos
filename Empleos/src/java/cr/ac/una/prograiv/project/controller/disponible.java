 ...
 * @author demc0
 */
@WebServlet(name = "disponible", urlPatterns = {"/disponible"})
public class disponible extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PuestoDao pda=new PuestoDao();
        pu=(Puesto)pda.findByID(id);
        if(disponible==2){
            pu.setDisponible(1);
        }
        if(disponible==1){
        ...
        pda.merge(pu);
        request.getRequestDispatcher("listaPuestos.jps").forward(request, response);
